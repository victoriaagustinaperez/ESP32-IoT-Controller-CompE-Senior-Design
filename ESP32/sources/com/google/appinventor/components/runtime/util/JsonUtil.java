...
public class JsonUtil {
    ...
    private static String writeFile(Form context, String input, String fileExtension) {
        File destDirectory = new File(context.getDefaultPath(BINFILE_DIR));
        ...
        try {
            ...
            new FileWriteOperation(context, context, "Write", dest.getAbsolutePath().replace(context.getDefaultPath(""), ""), context.DefaultFileScope(), false, true) {
